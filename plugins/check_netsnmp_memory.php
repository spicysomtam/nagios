<?php
#
# Template for check_netsnmp_memory.pl nagios plugin
# (plugin and template v 0.2 - last updated Jan 09, 2012)
# Copyright (c) 2010-2012 William Leibzon - http://william.leibzon.org/nagios/
#
$ds_name[1] = "System Memory";
$opt[1]  = " --vertical-label \"Memory (MB)\" -b 1000 --title \"Memory Use on $hostname\" ";

$def[1]  = "DEF:total_free=$RRDFILE[1]:$DS[1]:AVERAGE " ;
$def[1] .= "DEF:perc_avail_real=$RRDFILE[2]:$DS[2]:AVERAGE " ;
$def[1] .= "DEF:perc_avail_swap=$RRDFILE[3]:$DS[3]:AVERAGE ";
$def[1] .= "DEF:perc_buffer_real=$RRDFILE[4]:$DS[4]:AVERAGE ";
$def[1] .= "DEF:user=$RRDFILE[5]:$DS[5]:AVERAGE ";
$def[1] .= "DEF:perc_user_real=$RRDFILE[6]:$DS[6]:AVERAGE ";
$def[1] .= "DEF:avail_swap=$RRDFILE[7]:$DS[7]:AVERAGE ";
$def[1] .= "DEF:perc_used_real=$RRDFILE[8]:$DS[8]:AVERAGE ";
$def[1] .= "DEF:used_swap=$RRDFILE[9]:$DS[9]:AVERAGE ";
$def[1] .= "DEF:total=$RRDFILE[10]:$DS[10]:AVERAGE ";
$def[1] .= "DEF:perc_cached_real=$RRDFILE[11]:$DS[11]:AVERAGE ";
$def[1] .= "DEF:cached=$RRDFILE[12]:$DS[12]:AVERAGE ";
$def[1] .= "DEF:total_swap=$RRDFILE[13]:$DS[13]:AVERAGE ";
$def[1] .= "DEF:buffer=$RRDFILE[14]:$DS[14]:AVERAGE ";
$def[1] .= "DEF:min_swap=$RRDFILE[15]:$DS[15]:AVERAGE ";
$def[1] .= "DEF:avail_real=$RRDFILE[16]:$DS[16]:AVERAGE ";
$def[1] .= "DEF:total_real=$RRDFILE[17]:$DS[17]:AVERAGE ";
$def[1] .= "DEF:perc_used_swap=$RRDFILE[18]:$DS[18]:AVERAGE ";
